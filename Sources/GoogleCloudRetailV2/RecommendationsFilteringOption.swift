...
public enum RecommendationsFilteringOption: Codable, Equatable, Sendable {
  ...
  ///
  /// [google.cloud.retail.v2.RecommendationsFilteringOption.RECOMMENDATIONS_FILTERING_DISABLED]: <doc:RecommendationsFilteringOption/recommendationsFilteringDisabled>
  case unspecified
  ...
  public var intValue: Int? {
    ...
    case .recommendationsFilteringDisabled: return 1
    case .recommendationsFilteringEnabled: return 3
  ...
  public var stringValue: Swift.String? {
    ...
    case .recommendationsFilteringEnabled: return "RECOMMENDATIONS_FILTERING_ENABLED"
  ...
  ///
  /// If the value is unknown, this initializes to [`unknownStringValue`](doc:RecommendationsFilteringOption/unknownStringValue(_:)).
  public init(stringValue: Swift.String) {
    ...
    case "RECOMMENDATIONS_FILTERING_ENABLED": self = .recommendationsFilteringEnabled
  ...
  ///
  /// If the value is unknown, this initializes to [`unknownIntValue`](doc:RecommendationsFilteringOption/unknownIntValue(_:)).
  public init(intValue: Int) {
    switch intValue {
    case 0: self = .unspecified
    case 1: self = .recommendationsFilteringDisabled
    case 3: self = .recommendationsFilteringEnabled
