  ...
  Sendable
{
  ...
  private struct CodingKeys: CodingKey {
    ...
    static let userEventRejoinScope = CodingKeys(stringValue: "userEventRejoinScope")
  ...
  public init(from decoder: Decoder) throws {
    ...
    if let value = try container.decodeIfPresent(
      RejoinUserEventsRequest.UserEventRejoinScope.self, forKey: .userEventRejoinScope)
    {
      self.userEventRejoinScope = value
    }
  ...
  public enum UserEventRejoinScope: Codable, Equatable, Sendable {
    ...
    public func encode(to encoder: Encoder) throws {
      ...
      case .joinedEvents: return try container.encode("JOINED_EVENTS")
      case .unjoinedEvents: return try container.encode("UNJOINED_EVENTS")
