...
public struct CreateModelRequest: Codable, Equatable, GoogleCloudWKT._AnyPackable,
  Sendable
{
  ...
  /// Initialize a new instance of `CreateModelRequest`.
  public init() {}
  ...
  ///
  /// ```
  /// let value = CreateModelRequest().with { $0.parent = ... }
  /// ```
  ...
  public static var _anyTypeUrl: Swift.String {
    return "type.googleapis.com/google.cloud.retail.v2.CreateModelRequest"
  }
