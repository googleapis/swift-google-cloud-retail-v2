...
public struct AddFulfillmentPlacesMetadata: Codable, Equatable, GoogleWKT._AnyPackable,
  Sendable
{
  @_spi(GoogleCloudInternal) public var _unknownFields: GoogleWKT._UnknownFields = .init()

  /// Initialize a new instance of `AddFulfillmentPlacesMetadata`.
  public init() {}
  ...
  ///
  /// ```
  /// let value = AddFulfillmentPlacesMetadata().with { $0.<placeholder> = ... }
  /// ```
