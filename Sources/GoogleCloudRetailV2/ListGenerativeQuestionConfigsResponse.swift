...
public struct ListGenerativeQuestionConfigsResponse: Codable, Equatable, GoogleWKT._AnyPackable,
  Sendable
{
  ...
  /// Initialize a new instance of `ListGenerativeQuestionConfigsResponse`.
  public init() {}
  ...
  ///
  /// ```
  /// let value = ListGenerativeQuestionConfigsResponse().with { $0.generativeQuestionConfigs = ... }
  /// ```
  ...
  public static var _anyTypeUrl: Swift.String {
    return "type.googleapis.com/google.cloud.retail.v2.ListGenerativeQuestionConfigsResponse"
  }
