...
public struct AddCatalogAttributeRequest: Codable, Equatable, GoogleWKT._AnyPackable,
  Sendable
{
  ...
  /// Initialize a new instance of `AddCatalogAttributeRequest`.
  public init() {}
  ...
  ///
  /// ```
  /// let value = AddCatalogAttributeRequest().with { $0.attributesConfig = ... }
  /// ```
  ...
  public static var _anyTypeUrl: Swift.String {
    return "type.googleapis.com/google.cloud.retail.v2.AddCatalogAttributeRequest"
  }
