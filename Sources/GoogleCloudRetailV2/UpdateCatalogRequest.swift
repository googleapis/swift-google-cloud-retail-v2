...
public struct UpdateCatalogRequest: Codable, Equatable, GoogleWKT._AnyPackable,
  Sendable
{
  ...
  public init(from decoder: Decoder) throws {
    ...
    self.catalog = try container.decodeIfPresent(Catalog.self, forKey: .catalog)
  ...
  public func encode(to encoder: Encoder) throws {
    ...
    try container.encodeIfPresent(self.catalog, forKey: .catalog)
