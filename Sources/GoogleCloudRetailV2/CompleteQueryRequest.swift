...
public struct CompleteQueryRequest: Codable, Equatable, GoogleWKT._AnyPackable,
  Sendable
{
  ...
  ///
  /// [google.cloud.retail.v2.CompletionService.ImportCompletionData]: <doc:CompletionServiceClient/importCompletionData(request:options:)>
