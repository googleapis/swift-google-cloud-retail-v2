...
extension Clients {
  final class ConversationalSearchServiceRetry: ConversationalSearchServiceStub {
    ...
    public init(_ inner: any ConversationalSearchServiceStub, options: GoogleCloudGax.ClientOptions)
    {
      self.inner = inner
    ...
    public func conversationalSearch(
      ...
      try await self._intercept(
        ...
        idempotent: false,
        action: {
          (r: ConversationalSearchRequest, o: GoogleCloudGax.RequestOptions) async throws
