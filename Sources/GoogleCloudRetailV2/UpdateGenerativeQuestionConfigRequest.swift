...
public struct UpdateGenerativeQuestionConfigRequest: Codable, Equatable, GoogleWKT._AnyPackable,
  Sendable
{
  ...
  private struct CodingKeys: CodingKey {
    ...
    static let generativeQuestionConfig = CodingKeys(stringValue: "generativeQuestionConfig")
