...
public struct ExportErrorsConfig: Codable, Equatable, GoogleCloudWKT._AnyPackable,
  Sendable
{
  /// Required. Errors destination.
  public var destination: OneOf_Destination? = nil

  /// Initialize a new instance of `ExportErrorsConfig`.
  public init() {}
  ...
  ///
  /// ```
  /// let value = ExportErrorsConfig().with { $0.gcsPrefix = ... }
  /// ```
