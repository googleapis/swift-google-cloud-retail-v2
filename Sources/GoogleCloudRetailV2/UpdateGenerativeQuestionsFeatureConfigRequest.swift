...
public struct UpdateGenerativeQuestionsFeatureConfigRequest: Codable, Equatable, GoogleCloudWKT
    ._AnyPackable,
  Sendable
{
  /// Required. The configuration managing the feature state.
  public var generativeQuestionsFeatureConfig: GenerativeQuestionsFeatureConfig? = nil
  ...
  /// Initialize a new instance of `UpdateGenerativeQuestionsFeatureConfigRequest`.
  public init() {}
  ...
  ///
  /// ```
  /// let value = UpdateGenerativeQuestionsFeatureConfigRequest().with { $0.generativeQuestionsFeatureConfig = ... }
  /// ```
  ...
  private struct CodingKeys: CodingKey {
    ...
    static let generativeQuestionsFeatureConfig = CodingKeys(
      stringValue: "generativeQuestionsFeatureConfig")
  ...
  public func encode(to encoder: Encoder) throws {
    ...
    try container.encodeIfPresent(
      self.generativeQuestionsFeatureConfig, forKey: .generativeQuestionsFeatureConfig)
