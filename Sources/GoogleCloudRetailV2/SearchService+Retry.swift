...
extension Clients {
  final class SearchServiceRetry: SearchServiceStub {
    let inner: any SearchServiceStub
    let options: GoogleCloudGax.ClientOptions

    public init(_ inner: any SearchServiceStub, options: GoogleCloudGax.ClientOptions) {
      self.inner = inner
      ...
      try await self._intercept(
        ...
        action: {
          (r: SearchRequest, o: GoogleCloudGax.RequestOptions) async throws
            -> GoogleCloudRetailV2.SearchResponse
          in
