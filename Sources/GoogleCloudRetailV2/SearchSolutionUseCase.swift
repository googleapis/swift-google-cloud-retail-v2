...
public enum SearchSolutionUseCase: Codable, Equatable, Sendable {
  ...
  public func encode(to encoder: Encoder) throws {
    ...
    switch self {
    case .unspecified: return try container.encode("SEARCH_SOLUTION_USE_CASE_UNSPECIFIED")
    case .search: return try container.encode("SEARCH_SOLUTION_USE_CASE_SEARCH")
    case .browse: return try container.encode("SEARCH_SOLUTION_USE_CASE_BROWSE")
