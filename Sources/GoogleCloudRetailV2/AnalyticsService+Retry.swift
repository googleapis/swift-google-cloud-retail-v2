...
extension Clients {
  final class AnalyticsServiceRetry: AnalyticsServiceStub {
    let inner: any AnalyticsServiceStub
    let options: GoogleCloudGax.ClientOptions

    public init(_ inner: any AnalyticsServiceStub, options: GoogleCloudGax.ClientOptions) {
      self.inner = inner
    ...
    public func exportAnalyticsMetrics(
      ...
      try await self._intercept(
        ...
        idempotent: false,
        action: {
          (r: ExportAnalyticsMetricsRequest, o: GoogleCloudGax.RequestOptions) async throws
            -> GoogleLongRunning.Operation
          in
          return try await self.inner.exportAnalyticsMetrics(request: r, options: o)
        })
    }
