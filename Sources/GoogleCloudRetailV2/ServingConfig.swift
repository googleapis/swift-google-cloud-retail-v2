  ...
  Sendable
{
  ...
  public enum DiversityType: Codable, Equatable, Sendable {
    ...
    ///
    /// If the value is unknown, this initializes to [`unknownStringValue`](doc:DiversityType/unknownStringValue(_:)).
    ...
    ///
    /// If the value is unknown, this initializes to [`unknownIntValue`](doc:DiversityType/unknownIntValue(_:)).
    ...
    public func encode(to encoder: Encoder) throws {
      ...
      switch self {
      case .unspecified: return try container.encode("DIVERSITY_TYPE_UNSPECIFIED")
      case .ruleBasedDiversity: return try container.encode("RULE_BASED_DIVERSITY")
      case .dataDrivenDiversity: return try container.encode("DATA_DRIVEN_DIVERSITY")
