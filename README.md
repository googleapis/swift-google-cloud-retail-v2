...
Add `swift-google-cloud-retail-v2` as a package dependency:

```bash
swift package add-dependency https://github.com/googleapis/swift-google-cloud-retail-v2.git --from 0.1.0-preview
```

Then add `GoogleCloudRetailV2` to your target's dependencies:

```bash
swift package add-target-dependency GoogleCloudRetailV2 <target-name> --package swift-google-cloud-retail-v2
```
